...
cmake .. # set gcc compiler version > 7, set nvcc compiler: -D CMAKE_C_COMPILER=/usr/bin/gcc-9 -D CMAKE_CUDA_COMPILER=/usr/local/cuda-11.5/bin/nvcc
make -j # Unlimited means It might fork more jobs than you have processor cores available
cd ..
```
